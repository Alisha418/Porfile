export const profile = {
  ...
  /** File in `public/` — URL-encoded spaces for reliable linking */
  resumePath: '/Resume%20Alisha.pdf',
  /** Filename offered when downloading */
  resumeDownloadName: 'Resume Alisha.pdf',
}
